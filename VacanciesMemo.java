...
public class VacanciesMemo extends JFrame
{
	...
	public JLabel [] fnLabel=new JLabel[6];
	...
	public JTextField [] fnTF=new JTextField[6];
	...
	public String FILEname="C:/Memo/Vacancies/Applied.For./2019/February/";
	...
	String [] dirMAP={"C:/Memo/","C:/Memo/Vacancies/","C:/Memo/Vacancies/Applied.For./","C:/Memo/Vacancies/Applied.For./2019/","C:/Memo/Vacancies/Applied.For./2019/February/"};
   ...
   programVsion.addMouseListener(new MouseAdapter() 
	...
	JOptionPane.showMessageDialog(null," \n Job Applications Memo - version 1.00 - \n 02/2019 \n ;-) \n ","INFORMATION MESSAGE",JOptionPane.INFORMATION_MESSAGE);
 ...
 // public String [] menu=new String[]{"Job Advertisment Media","Advertised Organization","Job Title","Job Description","Date Posted","Application Submission Date"};  
	  ...
	  createFile.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				for(int u1=0;u1<elements.length;u1++)
				{
	...
	//	String fileNAME = hn1 ;
			...
			//	String date=a;
				...
				String sometext=FILEname+fnTF[1].getText()+".job.vacancy."+a+".txt";
	...
	// reset components
		...
		JFrame frame=new JFrame(" Job Applications Memo - version 1.00 - ");
		frame.add(box);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String [] VacanciesMemo)
	{
